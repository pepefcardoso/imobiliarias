"""
scrapers/imobicasa.py
Scraper para Imobicasa (https://imobicasa.com.br).
...
class ImobicasaScraper(AgencyScraper):
    """
    Scraper para Imobicasa — Tubarão/SC.
