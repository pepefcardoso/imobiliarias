"""
scrapers/litoralsulimoveis.py

Scraper para Litoral Sul Imóveis (https://litoralsulimoveis.com.br).
...
class LitoralSulImoveisScraper(AgencyScraper):
    """
    Scraper para Litoral Sul Imóveis — Tubarão/SC.
    ...
    def _normalize(self, raw: dict[str, Any]) -> Property | None:
        try:
            ...
            # Endereço: Extrai bairro (Ex: "Oficinas - Tubarão/SC")
