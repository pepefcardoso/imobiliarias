"""
scrapers/loteazul.py
Scraper para Lote Azul (https://loteazul.com.br).
...
# Endpoint v1 identificado no tráfego de rede
API_ENDPOINT = "https://api-sites.gerenciarimoveis-cf.com.br/api/properties"
PAGE_SIZE = 21
CITY_SLUG = "tubarao-sc"

class LoteAzulScraper(AgencyScraper):
    """
    Scraper para Lote Azul — Tubarão/SC.
    ...
    def _normalize(self, raw: dict[str, Any]) -> Property | None:
        ...
        try:
            ...
            # Prioriza área total, depois privativa
            ...
            return Property(
                ...
                url=f"{BASE_URL}/imovel/{slug}" if not slug.startswith("http") else slug,
